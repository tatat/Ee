...
define([], function() {
  ...
  var __for_each = !Array.prototype.forEach ? function (array, callback) {
  ...
  Ee.prototype.once = function(event_types, listeners, first, until) {
    return this.on(event_types, listeners, 1, first);
  };

  Ee.prototype.first = function(event_types, listeners, times, until) {
    return this.on(event_types, listeners, times, true);
  };
  ...
  Ee.prototype.within = function(ms, event_types, listeners, times, first, until) {
    var self = this
      , last_listeners = this.on(event_types, listeners, times, first).__listeners;
  ...
  Ee.prototype.trigger = function(event_type, args, fn) {
    var e
